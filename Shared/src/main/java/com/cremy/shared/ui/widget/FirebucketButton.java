...
public class FirebucketButton extends Button {
    ...
    private static Typeface TYPEFACE = null;
        ...
        public FirebucketButton(Context context) {
              super(context);
              applyTypeface(context);
        }

	    public FirebucketButton(Context context, AttributeSet attrs) {
	        super(context, attrs);
	        applyTypeface(context);

	    }

	    public FirebucketButton(Context context, AttributeSet attrs, int defStyle) {
